import{_ as c,c as d,a as e,e as s,d as a,w as o,b as l,r as p,o as r}from"./app-BSE58G7I.js";const u={},v={href:"https://github.com/Stephen-wzw/webpack-demo",target:"_blank",rel:"noopener noreferrer"},k={href:"https://webpack.docschina.org/configuration/module/",target:"_blank",rel:"noopener noreferrer"};function m(g,n){const i=p("ExternalLinkIcon"),t=p("RouteLink");return r(),d("div",null,[e("blockquote",null,[e("p",null,[n[1]||(n[1]=s("项目地址：",-1)),e("a",v,[n[0]||(n[0]=s("https://github.com/Stephen-wzw/webpack-demo",-1)),a(i)])])]),e("p",null,[n[3]||(n[3]=s("继续使用",-1)),a(t,{to:"/frontend/engineering/webpack/0006%E3%80%81webpack%E6%89%93%E5%8C%85CSS.html"},{default:o(()=>[...n[2]||(n[2]=[s("之前的项目",-1)])]),_:1}),n[4]||(n[4]=s("。",-1))]),n[8]||(n[8]=l(`<h2 id="打包图片资源" tabindex="-1"><a class="header-anchor" href="#打包图片资源"><span>打包图片资源</span></a></h2><p>在项目中引入图片文件夹，并添加两张图片：</p><p><strong>project</strong></p><div class="language-diff line-numbers-mode" data-ext="diff" data-title="diff"><pre class="language-diff"><code><span class="token unchanged"><span class="token prefix unchanged"> </span><span class="token line"> webpack-demo
...
</span></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>generator</code> 可以配置生成器的选项，<code>parser</code> 可以配置解析器的选项。</p>`,19)),e("blockquote",null,[e("p",null,[n[6]||(n[6]=s("具体配置项可查阅",-1)),e("a",k,[n[5]||(n[5]=s("官方文档",-1)),a(i)]),n[7]||(n[7]=s("。",-1))])]),n[9]||(n[9]=l(`<p>其中 <code>dataUrlCondition</code> 的含义为：如果一个模块源码大小小于 maxSize，那么模块会被作为一个 Base64 编码的字符串注入到包中， 否则模块文件会被生成到输出的目标目录中。</p><h2 id="打包字体资源" tabindex="-1"><a class="header-anchor" href="#打包字体资源"><span>打包字体资源</span></a></h2><p>在项目中引入字体文件夹，并添加字体文件：</p><p><strong>project</strong></p><div class="language-diff line-numbers-mode" data-ext="diff" data-title="diff"><pre class="language-diff"><code><span class="token unchanged"><span class="token prefix unchanged"> </span><span class="token line"> webpack-demo
</span><span class="token prefix unchanged"> </span><span class="token line"> |- node_modules
</span><span class="token prefix unchanged"> </span><span class="token line"> |- package-lock.json
</span><span class="token prefix unchanged"> </span><span class="token line"> |- package.json
</span><span class="token prefix unchanged"> </span><span class="token line"> |- index.html
...
<span class="token unchanged"><span class="token prefix unchanged"> </span><span class="token line">// 导入图片
...
<span class="token unchanged"><span class="token prefix unchanged"> </span><span class="token line">// 方式一：设置 img 元素的 src
...
<span class="token unchanged"><span class="token prefix unchanged"> </span><span class="token line">// 方式二：设置背景图片
...
</span></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>执行 <code>npm run build</code> 打包，接下来打开浏览器可以看到 <code>i</code> 元素正常加载，控制台也未报错。</p><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结"><span>总结</span></a></h2><p>webpack5 提供四种资源模块类型代替之前的 loader，可以对图片、字体等资源进行打包。</p>`,12))])}const b=c(u,[["render",m],["__file","03-asset-handling.html.vue"]]),h=JSON.parse('{"path":"/frontend/engineering/webpack/03-asset-handling.html","title":"webpack 打包其他资源","lang":"zh-CN","frontmatter":{"title":"webpack 打包其他资源","date":"2022-05-13T00:00:00.000Z","category":["工程化"],"tag":["项目打包","webpack"],"description":" 项目地址：https://github.com/Stephen-wzw/webpack-demo 继续使用。 打包图片资源 在项目中引入图片文件夹，并添加两张图片： project 下面通过两种方式引入图片资源： img 元素，设置 src 属性； 其他元素，css 设置 background-image 属性。 index.js 为方式二修改 st...","head":[["meta",{"property":"og:url","content":"https://dribble-njr.github.io/blog/notes/frontend/engineering/webpack/03-asset-handling.html"}],["meta",{"property":"og:title","content":"webpack 打包其他资源"}],["meta",{"property":"og:description","content":" 项目地址：https://github.com/Stephen-wzw/webpack-demo 继续使用。 打包图片资源 在项目中引入图片文件夹，并添加两张图片： project 下面通过两种方式引入图片资源： img 元素，设置 src 属性； 其他元素，css 设置 background-image 属性。 index.js 为方式二修改 st..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2026-04-20T16:21:10.000Z"}],["meta",{"property":"article:author","content":"njr"}],["meta",{"property":"article:tag","content":"项目打包"}],["meta",{"property":"article:tag","content":"webpack"}],["meta",{"property":"article:published_time","content":"2022-05-13T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2026-04-20T16:21:10.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"webpack 打包其他资源\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2022-05-13T00:00:00.000Z\\",\\"dateModified\\":\\"2026-04-20T16:21:10.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"njr\\",\\"url\\":\\"https://github.com/dribble-njr/blog\\",\\"email\\":\\"wzw15292257101@163.com\\"}]}"]]},"headers":[{"level":2,"title":"1 打包图片资源","slug":"打包图片资源","link":"#打包图片资源","children":[]},{"level":2,"title":"2 打包字体资源","slug":"打包字体资源","link":"#打包字体资源","children":[]},{"level":2,"title":"3 总结","slug":"总结","link":"#总结","children":[]}],"git":{"createdTime":1776702070000,"updatedTime":1776702070000,"contributors":[{"name":"ziven","email":"contact@ziven.me","commits":1}]},"readingTime":{"minutes":3.43,"words":1030},"filePathRelative":"frontend/engineering/webpack/03-asset-handling.md","localizedDate":"2022年5月13日","excerpt":"","autoDesc":true}');export{b as comp,h as data};
