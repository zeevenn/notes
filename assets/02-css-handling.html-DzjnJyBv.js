import{_ as d,c as o,a as e,e as n,d as a,w as i,b as p,r as t,o as r}from"./app-YZDrQOgx.js";const u={},v={href:"https://github.com/Stephen-wzw/webpack-demo",target:"_blank",rel:"noopener noreferrer"};function k(m,s){const c=t("ExternalLinkIcon"),l=t("RouteLink");return r(),o("div",null,[e("blockquote",null,[e("p",null,[s[1]||(s[1]=n("项目地址：",-1)),e("a",v,[s[0]||(s[0]=n("https://github.com/Stephen-wzw/webpack-demo",-1)),a(c)])])]),e("p",null,[s[3]||(s[3]=n("继续使用",-1)),a(l,{to:"/frontend/engineering/webpack/001-webpack-basic.html"},{default:i(()=>[...s[2]||(s[2]=[n("之前的项目",-1)])]),_:1}),s[4]||(s[4]=n("，不过在以下文件做点修改：",-1))]),s[8]||(s[8]=p(`<p><strong>index.html</strong></p><div class="language-diff line-numbers-mode" data-ext="diff" data-title="diff"><pre class="language-diff"><code><span class="token unchanged"><span class="token prefix unchanged"> </span><span class="token line">&lt;!DOCTYPE html&gt;
...
<span class="token inserted-sign inserted"><span class="token prefix inserted">+</span><span class="token line">const div = document.createElement(&quot;div&quot;);
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>webpack.config.js</strong></p><div class="language-diff line-numbers-mode" data-ext="diff" data-title="diff"><pre class="language-diff"><code>const path = require(&quot;path&quot;);
